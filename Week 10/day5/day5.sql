...
SELECT first_name,last_name,hire_date FROM employees WHERE hire_date < '1988/01/01' AND hire_date > '1986/01/01';
...
WHERE jobs.job_title != 'Programmer' AND jobs.job_title != 'Shipping Clerk' AND salary NOT IN (4500,10000) OR salary NOT IN (15000);
...
WHERE last_name IN ('Grant','Blake','Scott','King','Ford')
